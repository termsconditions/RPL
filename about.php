				...
				<div class="page-content">
                    ...
                    <div class="row" style="min-height: 350px;">
                        ...
                        <div class="col-md-7">
                            ...
                            <!-- Classic Heading -->
                            <h4 class="classic-title"><span>Selamat Datang!</span></h4>
                        ...
                        <div class="col-md-5"> 
                        	...
                        	<div class="touch-slider" data-slider-navigation="true" data-slider-pagination="true">
                                <div class="item"><img title="Member" alt="" src="images/allmember.jpg"></div>
                                <div class="item"><img  title="Research"  alt="" src="images/se.jpg"></div>
                                <div class="item"><img alt="" title="Study Group" src="images/sg.jpg"></div>
                            </div>
                            <!-- End Touch Slider -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- Classic Heading -->
                            <h4 class="classic-title"><span>Riset</span></h4>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- Classic Heading -->
                            <h4 class="classic-title"><span>Sub Kelompok</span></h4>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse-1">
                                                ...
                                                <i class="icon-award-1"></i> Study Group
                                            </a>
                                        </h4>
                                    </div>
                                    <!-- Toggle Content -->
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse-2" class="collapsed">
                                                <i class="icon-down-open-1 control-icon"></i>
                                                <i class="icon-laptop-1"></i> Research Group
                                            </a>
                                        </h4>
                                    </div>
                                    <!-- Toggle Content -->
                    ...
                    <div class="row">
                    	...
                    	<div class="col-md-3">
                            <div class="team-member">
                                ...
                                <div class="member-photo">
                                    <img alt="" src="images/mks.jpg" />
                                    <div class="member-name">Mira Kania Sabariah <span>Pembina</span></div>
                                </div>
                                <!-- Memebr Words -->
                        ...
                        <div class="col-md-3">
                            <div class="team-member">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="images/gino.jpg" />
                                    <div class="member-name">Gino Sunarto <span>Koordinator Lab</span></div>
                                </div>
                                <!-- Memebr Words -->
                                <div class="member-info">
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat.</p>
                        ...
                        <div class="col-md-3">
                            <div class="team-member">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="images/rani.jpg" />
                                    <div class="member-name">Maharani Asri Rahayu<span>Asisten Lab</span></div>
                                </div>
                                <!-- Memebr Words -->
                                <div class="member-info">
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat.</p>
                        ...
                        <div class="col-md-3">
                            <div class="team-member">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="images/fachrur.jpg" />
                                    <div class="member-name">Mohamad Fachrur Ridwan<span>Asisten Lab</span></div>
                                </div>
                                <!-- Memebr Words -->
                                <div class="member-info">
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat.</p>
